...
const SearchComponent = ({ value, onChange, placeholder = "Search research topics, hypotheses...", onKeyDown }: SearchComponentProps) => {
  return (
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          <input
            ...
            onChange={onChange}
            onKeyDown={onKeyDown}
            className="bg-[#010201] border-none w-[501px] h-[56px] rounded-lg text-white px-[59px] text-sm focus:outline-none placeholder-gray-300/70"
          />
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#cf30aa] top-[10px] left-[5px] blur-2xl opacity-40 transition-all duration-2000 group-hover:opacity-0"></div>
